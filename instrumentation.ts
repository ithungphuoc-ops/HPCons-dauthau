 ...
 * project app này thiếu thẻ thanh toán khiến nhiều nhân viên không vào được
 * app cả buổi, nhưng KHÔNG có bản ghi nào để tra lại đã xảy ra lúc mấy giờ).
 *
 ...
 * không cần bọc try/catch thủ công ở từng nơi. Xem
